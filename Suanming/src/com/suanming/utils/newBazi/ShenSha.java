...
public class ShenSha {
     ...
     * @return 1表示男人
     */
    public int Manorwoman(LvHeHun.sex param) {
        if (param.equals(LvHeHun.sex.man)) {
            return 1;
        }
        return 0;
    }
     ...
     * @return
     */
    public String[] liunianshensha(int[] yeararray, String[] bazi, LvHeHun.sex isman) {
     ...
     * @return
     */
    private String[] liunianshensha(int[] yearintarray,String[] yeararray, String[] bazi, LvHeHun.sex isman) {
        int ah;//年柱在六十甲子中的顺序
     ...
     * @return 神煞
     */
    public String shengshadayun(String yearjiazi, String[] bazi, LvHeHun.sex isman) {
        String returnString = "";
     ...
     * @return 神煞
     */
    public String shengsha(String[] bazi, LvHeHun.sex isman) {
        ...
        for (int i1 = 1;; i1++) {
            ...
            if ((CommonClass.yinyang(arrayOfString[2]).equals("阳") && Manorwoman(isman) == 1) || (CommonClass.yinyang(arrayOfString[2]).equals("阴") && Manorwoman(isman) == 0)) { //阳男阴女
    ...
    public int taijiguiren(String paramString1, String paramString2) {
        ...
        if (((paramString1.equals("戊")) || (paramString1.equals("己"))) && ((CommonClass.dizhiwuxing(paramString2).equals("土")) || (((paramString1.equals("庚")) || (paramString1.equals("辛"))) && ((paramString2.equals("寅")) || (paramString2.equals("亥")))))) {
            return 1;
        }
        return 0;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            myLuozhuangshengSha.paipan("2013-3-14 20", LvHeHun.sex.man);
        } catch (ParseException ex) {
            Logger.getLogger(ShenSha.class.getName()).log(Level.SEVERE, null, ex);
        }
