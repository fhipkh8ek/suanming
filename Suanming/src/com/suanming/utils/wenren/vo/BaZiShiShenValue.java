...
public class BaZiShiShenValue {
	...
	public void setBijian(double bijian) {
		this.bijian = bijian;
	}

	public double getJiecai() {
		return jiecai;
	}

	public void setJiecai(double jiecai) {
		this.jiecai = jiecai;
	}

	public double getShishen() {
		return shishen;
	}

	public void setShishen(double shishen) {
		this.shishen = shishen;
	}

	public double getShangguan() {
		return shangguan;
	}

	public void setShangguan(double shangguan) {
		this.shangguan = shangguan;
	}

	public double getZhengcai() {
		return zhengcai;
	}

	public void setZhengcai(double zhengcai) {
		this.zhengcai = zhengcai;
	}

	public double getPiancai() {
		return piancai;
	}

	public void setPiancai(double piancai) {
		this.piancai = piancai;
	}

	public double getZhengguan() {
		return zhengguan;
	}

	public void setZhengguan(double zhengguan) {
		this.zhengguan = zhengguan;
	}

	public double getQisha() {
		return qisha;
	}

	public void setQisha(double qisha) {
		this.qisha = qisha;
	}

	public double getZhengyin() {
		return zhengyin;
	}

	public void setZhengyin(double zhengyin) {
		this.zhengyin = zhengyin;
	}

	public double getPianyin() {
		return pianyin;
	}

	public void setPianyin(double pianyin) {
